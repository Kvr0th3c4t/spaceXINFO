    ...
    return (
        <div
            ...
            className="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-lg 
                       p-3 sm:p-4 md:p-4 lg:p-4 xl:p-5 2xl:p-5
        ...
        >
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <img
                    src={launch.image}
                    alt={launch.name}
                    className="w-full h-32 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-16 lg:h-16 xl:w-18 xl:h-18 2xl:w-20 2xl:h-20
                ...
                <div className="flex-1 min-w-0 space-y-2 sm:space-y-3">
                    ...
                    <p className="text-gray-400 text-xs sm:text-xs md:text-sm line-clamp-1 sm:line-clamp-1 md:line-clamp-2">
                        {launch.mission.name}
                    </p>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2 text-xs sm:text-xs md:text-sm text-gray-400">
                    ...
                    <div className="pt-2 sm:pt-3">
                        <Button
                            ...
                            className="w-full sm:w-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12
                                      py-2 sm:py-2 md:py-2 lg:py-3 xl:py-3 2xl:py-3
                                      text-xs sm:text-xs md:text-sm lg:text-sm xl:text-base 2xl:text-base
                                      uppercase"
                        />
                    </div>
                </div>
