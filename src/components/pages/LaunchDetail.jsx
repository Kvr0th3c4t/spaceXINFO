          ...
          <div className="relative z-10 flex flex-col bg-cover bg-right-bottom bg-no-repeat h-dvh w-full overflow-hidden"
            ...
            <div className="relative z-20 flex flex-col items-center h-full justify-center text-center font-['Azonix']">
              <BlurText
                ...
                animateBy="letters"
                direction="bottom"
                className="text-7xl mb-10 text-white font-extrabold"
              />
              <BlurText
                ...
                animateBy="letters"
                direction="bottom"
                className="text-5xl mb-10 text-white font-extrabold"
              />
              <Button text={"Información oficial"} href={`${data.infoURLs[0].url}`} target='_blank' className={"px-10 uppercase"}>
              </Button>
            </div>
          </div>
